        ...
        <div class="col-md-8  fd-propio-jam rounded">
            <article class="col-md-12">
                ...
                <figure class="col-md-12 pr-5 pl-5">
                    ...
                    <img src="img/li2.png" class="mb-3" alt="foto elastic girl">
                </figure>
                ...
                <div class="col-md-6 rounded">
                    <article>
                        ...
                        <figure>
                            ...
                            <img src="img/gt.jpeg" class="mb-3" alt="game of thrones">
                        </figure>
                        <p>La
                ...
                <div class="col-md-6 rounded">
                    <article>
                        ...
                        <figure>
                            ...
                            <img src="img/tf.jpeg" class="mb-3" alt="the flash">
                        </figure>
            ...
            <div class="offset-1 col-10">
                <div class="row">
                    ...
                    <figure class="col-5 my-auto hoverable">
                        <img src="img/ti2.jpg" alt="portada los increibles 2">
                    </figure>
                    <div class="col-7">
                        <ul>
                    ...
                    <div class="col-5 my-auto">
                        <img src="img/jw.jpg" alt="portada jurassic world">
                    </div>
                    <div class="col-7">
                        <ul>
                            <li>Fecha de Estreno en Argentina</li>
                    ...
                    <figure class="col-5 my-auto">
                        <img src="img/am.jpg" alt="Foto Portada Extraños">
                    </figure>
                    <div class="col-7">
                        <ul>
                            <li>Fecha de Estreno en Argentina</li>
